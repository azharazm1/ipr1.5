...
class PermohonanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $permohonan = Permohonan::create([
            ...
            'tarikh_tifoid' => $request->tarikh_tifoid,
            'tarikh_luput' => $request->tarikh_luput,
            'kursus_pengendali' => $request->kursus_pengendali,
            'tarikh_kursus' => $request->tarikh_kursus,
            'jenis_makanan' => $request->jenis_makanan,
            'ada_kenderaan' => $request->ada_kenderaan,
            'jenis_kenderaan' => $request->jenis_kenderaan,
            'tempat_vending' => $request->tempat_vending,
